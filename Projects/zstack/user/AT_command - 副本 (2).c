...
void Return_Message(uint8 length)
{
   ...
   osal_memcpy(at_status.DATA_buffer+10,pValue,8);
...
//                        DelayMS(200);
                ...
                default:
                   ...
                   HalUARTWrite(HAL_UART_PORT_0,at_status.DATA_buffer,22);
                break;
                  ...
                  if(strcmp(NWK_command.NWK_General_Frame.NWKCG_SourceAddress,0x00)==0 &&strcmp(NWK_command.NWK_General_Frame.NWKCG_TargetAddress,0x00)==0)
                    {
                          if(NWK_command.NWK_General_Frame.NWKCG_CMDID[0]==0x20)
                        {
                            if(NWK_command.NWK_General_Frame.NWK_AppDev_Frame.NWKCA_SUBIndex==0)
                            {
                                ...
                                NWK_command.NWK_General_Frame.NWK_AppDev_Frame.NWKCA_Data[8]=AssociatedDevList[0].shortAddr&0x00FF;
                                NWK_command.NWK_General_Frame.NWK_AppDev_Frame.NWKCA_Data[9]=AssociatedDevList[0].shortAddr&0xFF00>>8;
                                NWK_command.NWK_General_Frame.NWK_AppDev_Frame.NWKCA_Data[11]=0x01;
                                NWK_command.NWK_General_Frame.NWK_AppDev_Frame.NWKCA_Data[12]=0xC1;
                                NWK_command.NWK_General_Frame.NWK_AppDev_Frame.NWKCA_Data[13]=0x2B;
                                Return_Message(14);
                            }
                        }
                    }
