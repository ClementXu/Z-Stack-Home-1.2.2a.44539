...
uint32 *target[5];
target[1]=&ssss
void fixFunction(char *buffer,char * commandName,uint32 *data,uint8 length)
{
    uint8 i=0;
    char format[50];
    sprintf(format,"AT+%s=",commandName);
    for(i;i<length;i++)
    {
        if(i==0)
        {
...
void anaFunction(uint32 *source,uint32 *target,uint8 lenght)
{
    //lenght==0在函数外层处理
    for(i=0;i<lenght;i++)
    {
	...
	switch(index)
	{
         //获取MAC地址
            ...
            case ENUM_AT_LIGHT:
            {
                ...
                {   //设置指令
                    if(data[1]>0x29&&data[1]<0x32)
                    {
                        zclZHAtest_OnOff=data[1]-0x30
                        SendDatatoComputer(c);
                    }
                    else
                    {
                    ...
                    anaFunction(data[1],&zclZHAtest_OnOff,1);
                }
                if(data1[1]==0x30 )
                {
                    zclZHAtest_OnOff=0;
            ...
            case ENUM_AT_LEVEL:
            {
                ...
                {
                    zclZHAtest_OnOff=0;
                    //zclZHAtest_Level_to_Level=CovertACSIITWO(data2);
                    zclZHAtest_Level_to_Level = atoi(data2);
                    //zclZHAtest_Level_to_Level = uint8(zclZHAtest_Level_to_Level*25.4);
                    SendDatatoComputer(c);
                }
                else if(data1[1]==0x31 )
                {
...
//                        else
            ...
            case ENUM_AT_TEMP:
            {
                if(data1[0]!=0)
                {
                    ...
                    //zclZHAtest_Temperature_Value=CovertACSIIFOUR(data1);
                    SendDatatoComputer(c);  
                }
                else if(data1[0]==0)
                {     

//                    if(abs(zclZHAtest_Temperature_Value)<=0x000F)
//                            sprintf(at_status.DATA_buffer,"+OK=000%d\r\n",zclZHAtest_Temperature_Value);
//                    else if(abs(zclZHAtest_Temperature_Value)<=0x00FF && zclZHAtest_Temperature_Value>0x000F)
//                            sprintf(at_status.DATA_buffer,"+OK=00%d\r\n",zclZHAtest_Temperature_Value);
//                    else if(abs(zclZHAtest_Temperature_Value)<=0x0FFF && zclZHAtest_Temperature_Value>0x00FF)
//                            sprintf(at_status.DATA_buffer,"+OK=0%d\r\n",zclZHAtest_Temperature_Value);
//                    else
...
//                        if(zclZHAtest_Light_Color_Status<0x000F)
//                                sprintf(at_status.DATA_buffer,"+OK=0%x,0%x,000%x\r\n",zclZHAtest_OnOff,zclZHAtest_Level_to_Level,zclZHAtest_Light_Color_Status);
//                        else if(zclZHAtest_Temperature_Value<0x00FF && zclZHAtest_Temperature_Value>0x000F)
//                                sprintf(at_status.DATA_buffer,"+OK=0%x,0%x,00%x\r\n",zclZHAtest_OnOff,zclZHAtest_Level_to_Level,zclZHAtest_Light_Color_Status);
//                        else if(zclZHAtest_Temperature_Value<0x0FFF && zclZHAtest_Temperature_Value>0x00FF)
//                                sprintf(at_status.DATA_buffer,"+OK=0%x,0%x,0%x\r\n",zclZHAtest_OnOff,zclZHAtest_Level_to_Level,zclZHAtest_Light_Color_Status);
//                        else
                    ...
                    {
//                        if(zclZHAtest_Light_Color_Status<=0x000F)
//                                sprintf(at_status.DATA_buffer,"+OK=0%x,%x,000%x\r\n",zclZHAtest_OnOff,zclZHAtest_Level_to_Level,zclZHAtest_Light_Color_Status);
//                        else if(zclZHAtest_Temperature_Value<=0x00FF && zclZHAtest_Temperature_Value>0x000F)
//                                sprintf(at_status.DATA_buffer,"+OK=0%x,%x,00%x\r\n",zclZHAtest_OnOff,zclZHAtest_Level_to_Level,zclZHAtest_Light_Color_Status);
//                        else if(zclZHAtest_Temperature_Value<=0x0FFF && zclZHAtest_Temperature_Value>0x00FF)
//                                sprintf(at_status.DATA_buffer,"+OK=0%x,%x,0%x\r\n",zclZHAtest_OnOff,zclZHAtest_Level_to_Level,zclZHAtest_Light_Color_Status);
//                        else
                        sprintf(at_status.DATA_buffer,"+OK=0%x,%d,%d\r\n",zclZHAtest_OnOff,zclZHAtest_Level_to_Level,zclZHAtest_Light_Color_Status);
                    }                                        	
                    SendDatatoComputer(at_status.DATA_buffer);
            ...
            case ENUM_AT_HUMILITY:
            {
                ...
                {
//                    if(zclZHAtest_Humidity_Value<=0x0F)
...
//                    else
            ...
            case ENUM_AT_SOUNDLIGHTSENSOR:
            {
                ...
                {				
                    ...
                    {
                        //zclZHAtest_WD_Duration=(((data2[0]&0x0F)<<4)+(data2[1]&0x0F));
            ...
            case ENUM_AT_LUMIN:
            {
                ...
                {
//                    if(zclZHAtest_Illumiance_Value<0x000F)
//                       sprintf(at_status.DATA_buffer,"+OK=000%x\r\n",zclZHAtest_Illumiance_Value);
//                    else if(zclZHAtest_Illumiance_Value<0x00FF && zclZHAtest_Illumiance_Value>0x000F)
//                       sprintf(at_status.DATA_buffer,"+OK=00%x\r\n",zclZHAtest_Illumiance_Value);
//                    else if(zclZHAtest_Illumiance_Value<0x0FFF && zclZHAtest_Illumiance_Value>0x00FF)
//                       sprintf(at_status.DATA_buffer,"+OK=0%x\r\n",zclZHAtest_Illumiance_Value);
//                    else
                    sprintf(at_status.DATA_buffer,"+OK=%d\r\n",zclZHAtest_Illumiance_Value);
                    SendDatatoComputer(at_status.DATA_buffer);
